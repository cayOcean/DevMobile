...
// cria uma variavel que pega o nome digitado
const App = () => {
  const [nome, setNome] = useState('');
  const [mensagem, setMensagem] = useState('');

  // se o tiver um nome digitado, ele vai aparecer o texto 'Olá, "Nome"; caso não tenha, vai solicitar que voce escreva um
